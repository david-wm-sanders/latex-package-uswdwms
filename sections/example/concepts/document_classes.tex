...
The start of a top-level \LaTeX\ \texttt{.tex} file begins with a \term{\textbackslash documentclass[options]\{class\}} definition, as shown in Listing~\ref{primer:lst:document_class:report}.
