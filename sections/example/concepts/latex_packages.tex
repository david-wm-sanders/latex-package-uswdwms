...
Packages are imported using \term{\textbackslash usepackage[options]\{package name\}}. To use \uswdwmspkg{}, this is done as shown in Listing~\ref{example:lst:usepackage}.
