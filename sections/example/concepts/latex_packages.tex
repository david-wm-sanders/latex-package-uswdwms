...
Packages are imported using \term{\textbackslash usepackage[<options>]\{<package\_name>\}} -- the directive for importing the \uswdwmspkg{} is shown in Listing~\ref{primer:lst:usepackage}.
