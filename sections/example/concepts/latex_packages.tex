...
Packages are imported using \term{\textbackslash usepackage[options]\{package name\}}. To use the \uswdwmspkg{}, this is done as shown in Listing~\ref{example:lst:usepackage}.
