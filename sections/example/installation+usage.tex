...
\begin{methodology0}
  \item Ensure that:
    ...
    \end{itemize}
  \item Install Pygments\footnote{\href{https://pypi.org/project/Pygments/}{\faPython\ PyPI: Pygments}} with \term{pip.exe install Pygments} \textit{(this is required for syntax highlighting in code listings, with \texttt{minted})}
